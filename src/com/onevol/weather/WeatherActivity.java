...
import com.onevol.weather.bean.FutureWeatherBean;
import com.onevol.weather.bean.HoursWeatherBean;
import com.onevol.weather.bean.PMBean;
import com.onevol.weather.bean.WeatherBean;
import com.onevol.weather.service.WeatherService;
import com.onevol.weather.service.WeatherService.OnParserCallBack;
import com.onevol.weather.service.WeatherService.WeatherServiceBinder;
...
//            tv_dressing_index;// 穿衣指数
	...
	private void init() {
        mPullToRefreshScrollView = (SwipeRefreshLayout) findViewById(R.id.pull_refresh_scrollview);
        mPullToRefreshScrollView.setColorScheme(R.color.lochinvar,  R.color.amulet,  
                R.color.sweet_pink, R.color.cg_red); 
